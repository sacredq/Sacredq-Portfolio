...
//     const userLang = confirm("Do you really want to translate this page? Original text written on ENG.");
//     if(userLang){
//         const elements = document.querySelectorAll('h1, h2, h3, h4, h5, h6, a, span, button');

//         const textToTranslate = Array.from(elements).map(el => el.innerText);
...
//             const translations = translateData.map(t => t.translatedText);
